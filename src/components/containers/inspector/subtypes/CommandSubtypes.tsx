...
const commandSubtypes: CommandSubTypes = {
  ...
  persist_to_workspace: {
    ...
    description: "Persist a temporary file to be used by another job in the workflow",
    fields: (
      <div>
        Root
        <Field
          required
          name="parameters.root"
  ...
  store_artifacts: {
    ...
    description:
      'Step to store artifacts such as logs and binaries',
    fields: (
      <div>
        Path
        <Field
    ...
    generate: (values) =>
      new commands.StoreArtifacts({ ...values.parameters }),
  },
  store_test_results: {
  ...
  save_cache: {
    ...
    fields: (
      <div>
        ...
        <br />
        When
        <Field as="select" name="parameters.when">
          <option value="always">Always</option>
          <option value="on_success">On Success</option>
          <option value="on_fail">On Fail</option>
        </Field>
