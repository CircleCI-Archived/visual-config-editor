...
function ConnectionLine({ fromX, fromY, toX, toY, connectionLineStyle, fromNode, fromHandle }: ConnectionLineComponentProps) {
    ...
    console.log(fromX, realStartX, fromNode)
    ...
    return (
        ...
        <path style={connectionLineStyle} className="animated -z-30" fill="none" strokeWidth={1.5} stroke={color} d={edgePath} markerEnd="url(#triangle)" />
