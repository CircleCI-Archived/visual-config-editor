...
import { FlowActions, FlowActionsModel, FlowStore, FlowStoreModel } from '../../flow/state/FlowStore';
...
export interface DataModel<DataType = any, Mapping extends InspectableMapping = InspectableMapping> {
  data?: DataType;
  dataMapping?: Mapping;
}
  ...
  loadConfig: action((state, payload) => {
    ...
    const workflows = Object.assign(
      ...
      ...config.workflows.map((flow) => {
        ...
        const solved: Record<string, JobNodeProps> = {};
