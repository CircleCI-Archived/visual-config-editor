...
Thank you for considering to contribute to the CircleCI Visual Config Editor!
Before you get started, we recommend taking a look at the guidelines belowL
...
[submitting an issue](https://github.com/CircleCI-Public/visual-config-editor/issues)
...
- [Search Pull Requests](https://github.com/CircleCI-Public/visual-config-editor/pulls?q=)
- [Search Issues](https://github.com/CircleCI-Public/visual-config-editor/issues?q=)
...
1. In GitHub, send a Pull Request to `visual-config-editor:main`
...
[GitHub Project Boards](https://github.com/CircleCI-Public/visual-config-editor/projects)
...
4. On GitHub,
   [create a new Release](https://github.com/CircleCI-Public/visual-config-editor/releases/new)
